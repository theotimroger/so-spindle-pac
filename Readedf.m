function [x,Fs,Start_date,Start_time,Label,Dimension,Coef,Nmb_chans,N] = Readedf(t1,t2,ch,fname)
...
% Sinon, j'ouvre trop de files, mais je ne sais pas où !?!
fclose('all');
